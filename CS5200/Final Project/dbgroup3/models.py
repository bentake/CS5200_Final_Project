...
class Spot(models.Model):
    ...
    lot = models.ForeignKey(ParkingLot, models.DO_NOTHING, db_column='Lot_ID', blank=True, null=True)  # Field name made lowercase.
    spot_status = models.CharField(db_column='Spot_status', max_length=10, blank=True, null=True)  # Field name made lowercase.
...
class Vehicle(models.Model):
    license_plate = models.CharField(db_column='License_plate', primary_key=True, max_length=10)  # Field name made lowercase.
    make = models.CharField(db_column='Make', max_length=15, blank=True, null=True)  # Field name made lowercase.
    model = models.CharField(db_column='Model', max_length=15, blank=True, null=True)  # Field name made lowercase.
    year = models.IntegerField(db_column='Year', blank=True, null=True)  # Field name made lowercase.
    customer = models.ForeignKey(Customer, models.DO_NOTHING, db_column='Customer_ID', blank=True, null=True)  # Field name made lowercase.
    type = models.CharField(db_column='Type', max_length=5, blank=True, null=True)  # Field name made lowercase.
    number_of_doors = models.IntegerField(db_column='Number_of_doors', blank=True, null=True)  # Field name made lowercase.
    fuel_type = models.CharField(db_column='Fuel_type', max_length=10, blank=True, null=True)  # Field name made lowercase.
    cargo_capacity = models.IntegerField(db_column='Cargo_capacity', blank=True, null=True)  # Field name made lowercase.
